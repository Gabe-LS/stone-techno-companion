...
315 tests total — 261 core (`python -m pytest tests/ -v`: 241 chat + 20 transport) + 54 notification (Playwright, run separately):
...
- `test_chat_ws.py` (46) — WebSocket rooms, messaging, presence, moderation flow
- `test_chat_api.py` (75) — REST endpoints, auth (incl. email code login), rooms, meetups (incl. cancel-deletes-invite), DMs, admin
...
- `test_transport.py` (20) — departures proxy (tram DM + DUS Airport journey-planner mapping), walk targets/bounds (see "Public transport page")
